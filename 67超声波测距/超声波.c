...
void Conut(void)
{
	...
	/*计算方法，声波在空气中的传播速度是340m/s，
	晶振是11.0592，时钟周期：0，09042us,机器周期：1.08507us
	本次计时时间time*1.08507/1000/1000 = x s
	距离是来回两次的s = (340m/s *x s)/2 = time*0.1844619 mm
	12m晶振的s = time*0.17 mm
	如果不准确的话，可以进行修正，0.172等等
	*/
